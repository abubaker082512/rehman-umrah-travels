    ...
    <div className="bg-surface font-manrope text-on-surface min-h-screen">
      ...
      <section className="max-w-screen-2xl mx-auto px-8 py-16">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="font-notoSerif text-4xl lg:text-5xl font-bold text-primary leading-tight">Glimpses of the Divine</h2>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4 mb-12">
          {filters.map(f => (
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-bold transition-all ${activeFilter === f ? 'bg-[#013334] text-white' : 'bg-surface-container text-on-surface-variant hover:bg-surface-container-high'}`}
            >
              {f}
            </button>
          ))}
      ...
      <section className="py-24 bg-primary-container relative overflow-hidden">
        ...
        <div className="max-w-screen-2xl mx-auto px-8 relative z-10 text-center">
          ...
          <h2 className="font-notoSerif text-4xl lg:text-5xl font-bold text-white mb-6">Experience It Yourself</h2>
