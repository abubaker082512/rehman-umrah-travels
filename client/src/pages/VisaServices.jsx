        ...
        <div className="max-w-5xl mx-auto bg-surface-container-lowest text-center p-8 md:p-12 lg:p-16 relative overflow-hidden editorial-shadow">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+923220725064" className="border-2 border-outline-variant text-primary px-10 py-4 font-manrope font-bold tracking-widest uppercase text-sm hover:bg-surface-container transition-all flex items-center justify-center gap-2">
