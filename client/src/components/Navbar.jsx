  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 ${isVersion2 ? 'bg-[#013334]/80 backdrop-blur-md' : 'bg-[#013334] dark:bg-[#001c1d]'} shadow-[0_8px_40px_rgba(1,51,52,0.06)]`}>
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
        <Link to="/" className="font-notoSerif text-2xl font-bold tracking-tighter text-[#CD9933]">
          {isVersion2 ? 'Rehman Umrah & Travels' : 'REHMAN'}
        </Link>
        <div className="hidden md:flex items-center gap-8">
          <Link className="text-[#CD9933] border-b-2 border-[#CD9933] pb-1 font-semibold font-manrope text-sm tracking-wide" to="/">Home 1</Link>
          <Link className="text-white/80 font-medium hover:text-white transition-colors duration-300 font-manrope text-sm tracking-wide" to="/home2">Home 2</Link>
