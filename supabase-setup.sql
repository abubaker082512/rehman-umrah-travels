...
-- =============================================
-- ECONOMY PACKAGES (12 Packages)
-- =============================================
('21 Nights Saver Economy Umrah', 'Perform your holy pilgrimage with our affordable 21-day Economy package. Staying at Mayer Mayassar Mecca and Fursan Al Madinah, offering clean and peaceful accommodation.', 209500, 'Economy', '21 Days', 'Makkah & Madinah', 'Fundaq Mayer Mayassar', '800m from Haram', 'https://images.unsplash.com/photo-1591604129909-2b4ce4e6e6d2?w=800&q=80', 'Air Blue', 3, 'Best Price', 
 ARRAY['E-Visa Processing', 'Shared Ground Transport', 'Makkah Ziyaraat', '24/7 Tour Support', 'Multilingual Guides'],
...
('21 Nights Comfort Economy Saver', 'A high-value family-oriented economy saver package featuring Jedat Al Khalil Mecca hotel and Karam Ajyad in Madinah.', 224500, 'Economy', '21 Days', 'Makkah & Madinah', 'Jedat Al Khalil', '750m from Haram', 'https://images.unsplash.com/photo-1564769662533-3f5aae93cec2?w=800&q=80', 'PIA', 3, 'Popular Saver', 
 ARRAY['E-Visa Processing', 'Shared Transport', 'Madinah Ziyaraat', '24/7 Support Line', 'Complimentary Zamzam'],
...
('21 Nights Johra Special Economy', 'Enjoy extended devotional stays in Makkah and Madinah with our popular Johra Majad and Al Ikram Palace package.', 229500, 'Economy', '21 Days', 'Makkah & Madinah', 'Johra Majad Hotel', '700m from Haram', 'https://images.unsplash.com/photo-1580338834642-8a3acf79b1b8?w=800&q=80', 'Gulf Air', 3, 'Group Special', 
 ARRAY['E-Visa Processing', 'Shared Bus Service', 'Ziyarat of Holy Sites', 'Group Scholar Support', 'Zamzam Water'],
 '[{"day":"Day 01","title":"Arrival & Umrah","description":"Arrive at Jeddah, GMC transfer to Johra Majad Makkah. Perform Umrah."},{"day":"Day 02 - 12","title":"Haram Prayers","description":"Spend 11 days in Makkah with daily group scholars support."},{"day":"Day 13 - 20","title":"Madinah Devotion","description":"Transfer to Al Ikram Palace Madinah for 8 nights of Ibadah."},{"day":"Day 21","title":"Homebound","description":"Transfer to airport for return flight."}]'::jsonb),

('21 Nights Ajyad Standard Economy', 'Highly popular choice for pilgrims looking for excellent standard services at a reasonable budget in Ajyad, Makkah.', 235500, 'Economy', '21 Days', 'Makkah & Madinah', 'Al Juhani Ajyad Hotel', '650m from Haram', 'https://images.unsplash.com/photo-1596435688717-2d2f3b0fc47a?w=800&q=80', 'Saudi Airlines', 3, 'Ajyad Choice', 
 ARRAY['E-Visa Processing', 'AC Transport', 'Makkah & Madinah Ziyarat', 'Support Desk', 'Zamzam Bottle'],
...
('21 Nights Extended Special Economy', 'Maximize your time in the holy land with our 21-night package. Features Mather Al Jewar Makkah and Arjwan Al Madinah.', 251500, 'Economy', '21 Days', 'Makkah & Madinah', 'Mather Al Jewar', '600m from Haram', 'https://images.unsplash.com/photo-1518655044366-5c5abf0cf1f4?w=800&q=80', 'Air Blue', 3, 'Top Economy', 
 ARRAY['E-Visa Processing', 'Luggage Handling', 'Guided Tours', '24/7 Helpline', 'Group Scholar Services'],
 '[{"day":"Day 01","title":"Welcome to Makkah","description":"Arrive in Makkah, check-in to Mather Al Jewar. Complete Umrah."},{"day":"Day 02 - 12","title":"Makkah Devotions","description":"Spend peaceful days in Ibadah at Haram. Group Ziyarat."},{"day":"Day 13 - 20","title":"Madinah Stays","description":"Transfer to Arjwan Al Madinah. Rest and Ibadah in Masjid Nabawi."},{"day":"Day 21","title":"Farewell","description":"Departure transfer to Jeddah Airport."}]'::jsonb),

('15 Nights Economy Saver Deal', 'Compact 15-day economy package offering Fundaq Mayer Mayassar in Makkah and Fursan Al Madinah in Madinah.', 189500, 'Economy', '15 Days', 'Makkah & Madinah', 'Fundaq Mayer Mayassar', '800m from Haram', 'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d8?w=800&q=80', 'PIA', 3, '15-Day Saver', 
 ARRAY['E-Visa Processing', 'Shared Ground Transport', 'Makkah Ziyaraat', '24/7 Helpline'],
 '[{"day":"Day 01","title":"Arrival Makkah","description":"Transfer from Jeddah to Mayer Mayassar Makkah. Perform Umrah."},{"day":"Day 02 - 08","title":"Makkah Devotion","description":"Prayers in Haram. Ziyarat of holy sites."},{"day":"Day 09 - 14","title":"Madinah Stays","description":"Transfer to Fursan Al Madinah. Prayers at Nabawi."},{"day":"Day 15","title":"Departure","description":"Return transfer to airport."}]'::jsonb),

('15 Nights Comfort Economy Package', 'Perfect balance of duration and price featuring Jedat Al Khalil Mecca hotel and Karam Ajyad.', 199500, 'Economy', '15 Days', 'Makkah & Madinah', 'Jedat Al Khalil', '750m from Haram', 'https://images.unsplash.com/photo-1591604129909-2b4ce4e6e6d2?w=800&q=80', 'Air Blue', 3, 'Budget Friendly', 
 ARRAY['E-Visa Processing', 'Shared Bus Service', 'Zamzam Included', 'Group Support'],
 '[{"day":"Day 01","title":"Arrival & Umrah","description":"Transfer to Makkah Jedat Al Khalil. Group Umrah."},{"day":"Day 02 - 08","title":"Makkah Stays","description":"Ibadah and daily prayers in Haram."},{"day":"Day 09 - 14","title":"Madinah Stays","description":"Proceed to Karam Ajyad Madinah. Ibadah at Nabawi."},{"day":"Day 15","title":"Departure","description":"Transfer to airport."}]'::jsonb),

('15 Nights Johra Standard Deal', 'Standard economy package for families. Spend 8 nights in Makkah Johra Majad and 7 nights in Madinah Al Ikram.', 204500, 'Economy', '15 Days', 'Makkah & Madinah', 'Johra Majad Hotel', '700m from Haram', 'https://images.unsplash.com/photo-1564769662533-3f5aae93cec2?w=800&q=80', 'Gulf Air', 3, 'Best Saver', 
 ARRAY['E-Visa Processing', 'Ground Transport', 'Ziyarat Tours', 'Zamzam water'],
 '[{"day":"Day 01","title":"Welcome Makkah","description":"Check-in Johra Majad Makkah. Perform Umrah."},{"day":"Day 02 - 08","title":"Makkah Ibadah","description":"Spend peaceful nights and pray in Haram."},{"day":"Day 09 - 14","title":"Madinah Ibadah","description":"Transfer to Al Ikram Madinah. Visit Uhud & Quba."},{"day":"Day 15","title":"Departure","description":"Check-out, transfer to airport."}]'::jsonb),

('15 Nights Ajyad Budget Choice', 'An outstanding budget package located in Ajyad, Makkah. Includes Makkah & Madinah Ziyarat.', 209500, 'Economy', '15 Days', 'Makkah & Madinah', 'Al Juhani Ajyad Hotel', '650m from Haram', 'https://images.unsplash.com/photo-1580338834642-8a3acf79b1b8?w=800&q=80', 'PIA', 3, 'Budget Deal', 
 ARRAY['E-Visa Processing', 'AC Coach Transport', 'Guided Tours', 'Zamzam bottle'],
 '[{"day":"Day 01","title":"Jeddah to Makkah","description":"Arrive Jeddah, transfer to Al Juhani Makkah. Perform Umrah."},{"day":"Day 02 - 08","title":"Haram Prayers","description":"Pray in Al-Haram, perform guided Ziyarat."},{"day":"Day 09 - 14","title":"Madinah Stays","description":"Transfer to Al Ikram Madinah. Pray in Nabawi."},{"day":"Day 15","title":"Return Flight","description":"Transfer to Jeddah airport."}]'::jsonb),

('10 Nights Economy Quick Saver', 'A quick, budget-friendly spiritual escape. 5 nights in Makkah and 5 nights in Madinah.', 159500, 'Economy', '10 Days', 'Makkah & Madinah', 'Fundaq Mayer Mayassar', '800m from Haram', 'https://images.unsplash.com/photo-1596435688717-2d2f3b0fc47a?w=800&q=80', 'Air Blue', 3, 'Quick Saver', 
 ARRAY['E-Visa Processing', 'Shared Transport', 'Ziyarat Pack', '24/7 Helpline'],
 '[{"day":"Day 01","title":"Makkah Check-in","description":"Arrive at Jeddah, direct transfer to Mayer Mayassar Makkah."},{"day":"Day 02 - 05","title":"Makkah Devotion","description":"Prayers in Haram. Guided Makkah tours."},{"day":"Day 06 - 09","title":"Madinah Devotion","description":"Proceed to Madinah. Direct access to Nabawi prayers."},{"day":"Day 10","title":"Home Return","description":"Check-out and transfer to airport."}]'::jsonb),

('10 Nights Comfort Economy Quick', 'Enjoy 10 days of peace with our popular economy hotels. 5 nights Makkah, 5 nights Madinah.', 169500, 'Economy', '10 Days', 'Makkah & Madinah', 'Jedat Al Khalil', '750m from Haram', 'https://images.unsplash.com/photo-1518655044366-5c5abf0cf1f4?w=800&q=80', 'PIA', 3, 'Express Saver', 
 ARRAY['E-Visa Processing', 'Shared Bus Transport', 'Guided Scholar Support'],
 '[{"day":"Day 01","title":"Arrival & Umrah","description":"Check-in Jedat Al Khalil Makkah. Group Umrah."},{"day":"Day 02 - 05","title":"Makkah Prayers","description":"Daily ibadah and prayers at Haram."},{"day":"Day 06 - 09","title":"Madinah Stays","description":"Transfer to Karam Ajyad Madinah. Ibadah at Nabawi."},{"day":"Day 10","title":"Departure","description":"Transfer to Jeddah for return flight."}]'::jsonb),

('10 Nights Budget Extended Choice', 'Excellent 10-day option featuring Johra Majad Mecca and Al Ikram Madinah.', 174500, 'Economy', '10 Days', 'Makkah & Madinah', 'Johra Majad Hotel', '700m from Haram', 'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d8?w=800&q=80', 'Gulf Air', 3, 'Express Deal', 
 ARRAY['E-Visa Processing', 'Ground Transport', 'Ziyarat in holy cities', 'Zamzam water'],
 '[{"day":"Day 01","title":"Arrive Makkah","description":"Arrive Jeddah, transfer to Johra Majad Makkah. Complete Umrah."},{"day":"Day 02 - 05","title":"Haram Devotions","description":"Pray in Al-Haram. Focus on prayers and Qur''an."},{"day":"Day 06 - 09","title":"Madinah Devotions","description":"Transfer to Al Ikram Madinah. Daily Nabawi prayers."},{"day":"Day 10","title":"Return Flight","description":"Return transfer to airport."}]'::jsonb),
